export default function Icon({ className }: { className?: string }) {
    return (
        ...
        //         </linearGradient>
        //         <g id="codetier-icon">
        //             <path d="M 30 130 L 100 165 L 170 130" stroke="#1e293b" stroke-width="16"
        //                 stroke-linecap="round" stroke-linejoin="round" />
        //             <path d="M 30 100 L 100 135 L 170 100" stroke="#1e293b" stroke-width="16"
        //                 stroke-linecap="round" stroke-linejoin="round" />
        //             <path d="M 100 25 L 180 65 L 100 105 L 20 65 Z" fill="url(#plateGrad)" />
        //             <path d="M 100 45 L 135 65 L 100 85 L 65 65 Z" stroke="url(#nodeGrad)" stroke-width="4"
